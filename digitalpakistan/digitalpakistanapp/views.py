...
# -------------------Start business_promotion-----------------------------------------


def business_promotion(request):
    template_name = "website/Business_promotion.html"
    if request.method == "GET":
        return render(request, template_name)

# -------------------End business_promotion-----------------------------------------

# -------------------Start business_promotion_details -----------------------------------------


def business_promotion_details(request):
    template_name = "website/business_promotion_details.html"
    if request.method == "GET":
        return render(request, template_name)

# -------------------End business_promotion_details -----------------------------------------
